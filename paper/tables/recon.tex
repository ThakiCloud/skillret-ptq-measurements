...
\midrule
Qwen3-Emb-0.6B & 0.865 & 0.648 & 0.62 \\
SkillRet-0.6B (finetuned) & 0.92 & 0.624 & 0.601 \\
EmbeddingGemma-300M & 0.91 & 0.775 & 0.633 \\
BGE-M3 & 0.897 & 0.635 & 0.524 \\
E5-base-v2 & 0.555 & 0.823 & 0.763 \\
\midrule
Pooled & 0.856 & 0.658 & 0.623 \\
\bottomrule
\end{tabular}\quad
\begin{tabular}{lrr}
\toprule
...
\midrule
BGE-M3 & 0.3146 & 98.2 \\
E5-base-v2 & 0.3195 & 58.1 \\
EmbeddingGemma-300M & 0.3373 & 34.3 \\
